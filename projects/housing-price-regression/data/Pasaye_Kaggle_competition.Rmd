...
# Load dataframe
df <- read.csv("train.csv") # change path if needed
...
# Output RMSE
write.csv(results, "C:\\Users\\joshp\\OneDrive\\Documents\\Kaggle\\House Price competition\\submission\\submission.csv")
```
...
write.csv(submission, "C:\\Users\\joshp\\OneDrive\\Documents\\Kaggle\\House Price competition\\submission\\submission.csv", 
          row.names = FALSE)
```